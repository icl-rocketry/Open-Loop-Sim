function [problem,guess] = GoddardRocket_Phase1(problem_mp, guess_mp,vector)
...
InternalDynamics=@GoddardRocket_Dynamics_Phase1;
SimDynamics=[];
...
% Settings file
problem.settings=@settings_GoddardRocketThreePhase_Phase1;
...
problem.states.x0l=[h_0 v_0 m_min];
problem.states.x0u=[h_0 v_0 m_max];
...
problem.states.xfu=[h_max v_max m_max];

% Guess the state trajectories with [x0 xf]
guess.states(:,1)=[h_min h_max/2];
guess.states(:,2)=[0 v_max/2];
guess.states(:,3)=[m_max (m_max-m_min)/2+m_min];
