function [problem,guess] = GoddardRocket_Phase2(problem_mp, guess_mp,vector)
...
InternalDynamics=@GoddardRocket_Dynamics_Phase2;
SimDynamics=[];
...
problem.states.xfl=[h_f 0 m_min];
problem.states.xfu=[h_f 0 m_min];
