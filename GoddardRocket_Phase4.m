function [problem,guess] = GoddardRocket_Phase4(problem_mp, guess_mp)
...
InternalDynamics=@GoddardRocket_Dynamics_Phase4;
SimDynamics=[];
...
% Settings file
problem.settings=@settings_GoddardRocketThreePhase_Phase2;

% Initial time. t0<tf
problem.time.t0_idx=4;
...
problem.states.xfl=[h_min 0 m_min];
problem.states.xfu=[h_max 0 m_max];

% Guess the state trajectories with [x0 xf]
guess.states(:,1)=[h_max/2 h_f];
